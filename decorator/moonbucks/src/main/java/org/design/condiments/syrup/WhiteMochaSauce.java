...
public class WhiteMochaSauce implements Coffee {

    private final Coffee coffee;

    public WhiteMochaSauce(Coffee coffee) {
        this.coffee = coffee;
    }
    ...
    public Map<String, Integer> description() {
        ...
        desc.put("White Mocha Sauce", Optional.ofNullable(desc.get("White Mocha Sauce")).orElse(0) + 1);
        return desc;
    }
