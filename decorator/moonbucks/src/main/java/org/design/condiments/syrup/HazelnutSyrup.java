...
public class HazelnutSyrup implements Coffee {

    private final Coffee coffee;

    public HazelnutSyrup(Coffee coffee) {
        this.coffee = coffee;
    }
    ...
    public Map<String, Integer> description() {
        ...
        desc.put("Hazelnut Syrup", Optional.ofNullable(desc.get("Hazelnut Syrup")).orElse(0) + 1);
        return desc;
    }
