...
public class CaramelDrizzle implements Coffee {

    private final Coffee coffee;

    public CaramelDrizzle(Coffee coffee) {
        this.coffee = coffee;
    }
    ...
    public Map<String, Integer> description() {
        ...
        desc.put("Caramel Drizzle", Optional.ofNullable(desc.get("Caramel Drizzle")).orElse(0) + 1);
        return desc;
    }
